...
const SignUp = () => {
  ...
  function isValidRGUKTEmail(email: string) {
    ...
    const s19Pattern = /^s19\d{4}$/;
    const s20Pattern = /^s20\d{4}$/;

    return rsPattern.test(localPart) || sPattern.test(localPart) ||  s19Pattern.test(localPart) || s20Pattern.test(localPart);
  }
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="rounded-md shadow-sm space-y-4">
            ...
            <div>
              ...
              >
                <option value="CheckIn">Scan Food</option>
                <option value="Food">Scan Pan</option>
                <option value="IceCream">Scan IceCream</option>
              </select>
            </div>
            <div>
